...
public class CrossReferencesRecord extends TableRecordImpl<CrossReferencesRecord> {
	...
	private static final long serialVersionUID = -131604466;
	...
	public CrossReferencesRecord(Configuration configuration) {
		super(configuration, CrossReferences.CROSS_REFERENCES);
	}
}
