...
public class SequencesRecord extends TableRecordImpl<SequencesRecord> {
	...
	private static final long serialVersionUID = -838206645;
	 ...
	 * An uncommented item
	 */
	public void setDeclaredNumericSclae(Long value) {
		setValue(Sequences.DECLARED_NUMERIC_SCLAE, value);
	}

	/**
	 * An uncommented item
	 */
	public Long getDeclaredNumericSclae() {
		return getValue(Sequences.DECLARED_NUMERIC_SCLAE);
	}
