...
public class AllArgumentsRecord extends TableRecordImpl<AllArgumentsRecord> {
	...
	private static final long serialVersionUID = 50223052;
	...
	public AllArgumentsRecord(Configuration configuration) {
		super(configuration, AllArguments.ALL_ARGUMENTS);
	}
}
