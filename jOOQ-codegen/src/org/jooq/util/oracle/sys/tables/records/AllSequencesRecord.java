...
public class AllSequencesRecord extends TableRecordImpl<AllSequencesRecord> {
	...
	private static final long serialVersionUID = 413110511;
	...
	public AllSequencesRecord(Configuration configuration) {
		super(configuration, AllSequences.ALL_SEQUENCES);
	}
}
