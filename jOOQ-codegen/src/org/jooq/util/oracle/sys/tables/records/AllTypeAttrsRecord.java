...
public class AllTypeAttrsRecord extends TableRecordImpl<AllTypeAttrsRecord> {
	...
	private static final long serialVersionUID = 162819507;
...
type specification or CREATE TYPE statement (not to be used as ID number)
	...
	public AllTypeAttrsRecord(Configuration configuration) {
		super(configuration, AllTypeAttrs.ALL_TYPE_ATTRS);
	}
}
