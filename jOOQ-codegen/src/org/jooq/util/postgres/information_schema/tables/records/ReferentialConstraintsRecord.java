...
public class ReferentialConstraintsRecord extends TableRecordImpl<ReferentialConstraintsRecord> {
	...
	private static final long serialVersionUID = -2072291386;
	...
	public ReferentialConstraintsRecord(Configuration configuration) {
		super(configuration, ReferentialConstraints.REFERENTIAL_CONSTRAINTS);
	}
}
