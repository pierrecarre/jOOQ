...
public class FormatType extends StoredFunctionImpl<String> {
	...
	private static final long serialVersionUID = -291058756;


	/**
	 * An uncommented item
	 */
	public static final Parameter<Long> _1 = new ParameterImpl<Long>("_1", SQLDataType.BIGINT);

	/**
	 * An uncommented item
	 */
	public static final Parameter<Integer> _2 = new ParameterImpl<Integer>("_2", SQLDataType.INTEGER);

	/**
	 * Create a new function call instance
	 */
	public FormatType() {
		super(SQLDialect.POSTGRES, "format_type", PgCatalog.PG_CATALOG, SQLDataType.CLOB);
