...
public class TBookStore extends UpdatableTableImpl<TBookStoreRecord> {
	...
	private static final long serialVersionUID = -358946152;
	 ...
	 * An uncommented item
	 */
	public static final TableField<TBookStoreRecord, Integer> ID = new TableFieldImpl<TBookStoreRecord, Integer>(SQLDialect.DB2, "ID", DB2DataType.INTEGER, T_BOOK_STORE);
