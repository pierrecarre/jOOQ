...
public class VLibrary extends TableImpl<VLibraryRecord> {
	...
	private static final long serialVersionUID = 1632875695;
	 ...
	 * An uncommented item
	 */
	public static final TableField<VLibraryRecord, String> AUTHOR = new TableFieldImpl<VLibraryRecord, String>(SQLDialect.DB2, "AUTHOR", String.class, V_LIBRARY);

	/**
	 * An uncommented item
	 */
	public static final TableField<VLibraryRecord, String> TITLE = new TableFieldImpl<VLibraryRecord, String>(SQLDialect.DB2, "TITLE", String.class, V_LIBRARY);
