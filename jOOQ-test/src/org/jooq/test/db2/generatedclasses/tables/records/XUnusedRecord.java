...
public class XUnusedRecord extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.db2.generatedclasses.tables.records.XUnusedRecord> {
	...
	private static final long serialVersionUID = -1912604953;
	 ...
	 * PRIMARY KEY
	 */
	public java.util.List<org.jooq.test.db2.generatedclasses.tables.records.XTestCase_85Record> fetchXTestCase_85List() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public java.util.List<org.jooq.test.db2.generatedclasses.tables.records.XTestCase_85Record> getXTestCase_85List() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.db2.generatedclasses.tables.XTestCase_85.X_TEST_CASE_85)
			.where(org.jooq.test.db2.generatedclasses.tables.XTestCase_85.X_UNUSED_ID.equal(getValue(org.jooq.test.db2.generatedclasses.tables.XUnused.ID)))
			.and(org.jooq.test.db2.generatedclasses.tables.XTestCase_85.X_UNUSED_NAME.equal(getValue(org.jooq.test.db2.generatedclasses.tables.XUnused.NAME)))
	 ...
	 * PRIMARY KEY
	 */
	public java.util.List<org.jooq.test.db2.generatedclasses.tables.records.XUnusedRecord> fetchXUnusedList() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public java.util.List<org.jooq.test.db2.generatedclasses.tables.records.XUnusedRecord> getXUnusedList() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.db2.generatedclasses.tables.XUnused.X_UNUSED)
			.where(org.jooq.test.db2.generatedclasses.tables.XUnused.ID_REF.equal(getValue(org.jooq.test.db2.generatedclasses.tables.XUnused.ID)))
			.and(org.jooq.test.db2.generatedclasses.tables.XUnused.NAME_REF.equal(getValue(org.jooq.test.db2.generatedclasses.tables.XUnused.NAME)))
	 ...
	 * PRIMARY KEY
	 */
	public java.util.List<org.jooq.test.db2.generatedclasses.tables.records.XTestCase_64_69Record> fetchXTestCase_64_69List() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public java.util.List<org.jooq.test.db2.generatedclasses.tables.records.XTestCase_64_69Record> getXTestCase_64_69List() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.db2.generatedclasses.tables.XTestCase_64_69.X_TEST_CASE_64_69)
			.where(org.jooq.test.db2.generatedclasses.tables.XTestCase_64_69.UNUSED_ID.equal(getValue(org.jooq.test.db2.generatedclasses.tables.XUnused.ID)))
			.fetch();
	...
	public XUnusedRecord(org.jooq.Configuration configuration) {
		super(org.jooq.test.db2.generatedclasses.tables.XUnused.X_UNUSED, configuration);
	}
}
