...
public class F317 extends StoredFunctionImpl<Integer> {
	...
	private static final long serialVersionUID = 731192281;


	/**
	 * An uncommented item
	 */
	public static final Parameter<Integer> P1 = new ParameterImpl<Integer>(SQLDialect.H2, "P1", H2DataType.INTEGER);

	/**
	 * An uncommented item
	 */
	public static final Parameter<Integer> P2 = new ParameterImpl<Integer>(SQLDialect.H2, "P2", H2DataType.INTEGER);

	/**
	 * An uncommented item
	 */
	public static final Parameter<Integer> P3 = new ParameterImpl<Integer>(SQLDialect.H2, "P3", H2DataType.INTEGER);

	/**
	 * An uncommented item
	 */
	public static final Parameter<Integer> P4 = new ParameterImpl<Integer>(SQLDialect.H2, "P4", H2DataType.INTEGER);

	/**
	 * Create a new function call instance
	 */
	public F317() {
		super(SQLDialect.H2, "F317", Public.PUBLIC, H2DataType.INTEGER);
