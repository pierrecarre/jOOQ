...
public class FArrays2 extends StoredFunctionImpl<Object[]> {
	...
	private static final long serialVersionUID = 2038316748;
	 ...
	 */
	public static final Parameter<Object[]> P1 = new ParameterImpl<Object[]>("P1", SQLDataType.OTHER.getArrayDataType());

	/**
	 * Create a new function call instance
	 */
	public FArrays2() {
		super(SQLDialect.H2, "F_ARRAYS2", Public.PUBLIC, SQLDataType.OTHER.getArrayDataType());
