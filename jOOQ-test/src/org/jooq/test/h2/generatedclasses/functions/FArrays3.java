...
public class FArrays3 extends StoredFunctionImpl<Object[]> {

	private static final long serialVersionUID = -2140923603;
	 ...
	 */
	public FArrays3() {
		super(SQLDialect.H2, "F_ARRAYS3", Public.PUBLIC, SQLDataType.OTHER.getArrayDataType());
