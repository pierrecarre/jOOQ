...
public class F317 extends StoredFunctionImpl<Integer> {
	...
	private static final long serialVersionUID = 1872538744;


	/**
	 * An uncommented item
	 */
	public static final Parameter<Integer> P1 = new ParameterImpl<Integer>(SQLDialect.HSQLDB, "P1", HSQLDBDataType.INTEGER);

	/**
	 * An uncommented item
	 */
	public static final Parameter<Integer> P2 = new ParameterImpl<Integer>(SQLDialect.HSQLDB, "P2", HSQLDBDataType.INTEGER);

	/**
	 * An uncommented item
	 */
	public static final Parameter<Integer> P3 = new ParameterImpl<Integer>(SQLDialect.HSQLDB, "P3", HSQLDBDataType.INTEGER);

	/**
	 * An uncommented item
	 */
	public static final Parameter<Integer> P4 = new ParameterImpl<Integer>(SQLDialect.HSQLDB, "P4", HSQLDBDataType.INTEGER);

	/**
	 * No further instances allowed
	 */
	public F317() {
		super(SQLDialect.HSQLDB, "F317", Public.PUBLIC, HSQLDBDataType.INTEGER);
