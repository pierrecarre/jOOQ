...
public class TBookStore extends UpdatableTableImpl<TBookStoreRecord> {
	...
	private static final long serialVersionUID = -1610418709;
	 ...
	 * An uncommented item
	 */
	public static final TableField<TBookStoreRecord, Integer> ID = new TableFieldImpl<TBookStoreRecord, Integer>(SQLDialect.HSQLDB, "ID", HSQLDBDataType.INTEGER, T_BOOK_STORE);
