...
public class F317 extends StoredFunctionImpl<Integer> {
	...
	private static final long serialVersionUID = -2062682024;


	/**
	 * An uncommented item
	 */
	public static final Parameter<Integer> P1 = new ParameterImpl<Integer>(SQLDialect.MYSQL, "p1", MySQLDataType.INT);

	/**
	 * An uncommented item
	 */
	public static final Parameter<Integer> P2 = new ParameterImpl<Integer>(SQLDialect.MYSQL, "p2", MySQLDataType.INT);

	/**
	 * An uncommented item
	 */
	public static final Parameter<Integer> P3 = new ParameterImpl<Integer>(SQLDialect.MYSQL, "p3", MySQLDataType.INT);

	/**
	 * An uncommented item
	 */
	public static final Parameter<Integer> P4 = new ParameterImpl<Integer>(SQLDialect.MYSQL, "p4", MySQLDataType.INT);

	/**
	 * Create a new function call instance
	 */
	public F317() {
		super(SQLDialect.MYSQL, "f317", Test.TEST, MySQLDataType.INT);
