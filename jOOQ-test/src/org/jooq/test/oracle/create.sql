...
INSERT INTO t_author VALUES (1, 'George', 'Orwell', TO_DATE('1903-06-25', 'YYYY-MM-DD'), 1903, u_address_type(u_street_type('Parliament Hill', '77'), 'NW31A9', 'Hampstead', 'England', TO_DATE('1980-01-01', 'YYYY-MM-DD'), null))
/
INSERT INTO t_author VALUES (2, 'Paulo', 'Coelho', TO_DATE('1947-08-24', 'YYYY-MM-DD'), 1947, u_address_type(u_street_type('Caixa Postal', '43.003'),  null, 'Rio de Janeiro', 'Brazil', TO_DATE('1940-01-01', 'YYYY-MM-DD'), 2))
/
...
CREATE OR REPLACE PACKAGE library AS
	...
	PROCEDURE pkg_p_author_exists (author_name VARCHAR2, result OUT NUMBER, unused OUT NUMBER);
...
CREATE OR REPLACE PACKAGE BODY library AS
	...
	PROCEDURE pkg_p_author_exists (author_name VARCHAR2, result OUT NUMBER, unused OUT NUMBER) IS
	BEGIN
		test.p_author_exists(author_name, result);
	END pkg_p_author_exists;
