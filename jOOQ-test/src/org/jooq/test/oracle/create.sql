...
CREATE OR REPLACE PROCEDURE p391 (
	...
	o2 OUT INTEGER, io2 IN OUT INTEGER, i2 INTEGER) IS
BEGIN
  o1 := io1;
  io1 := i1;
...
CREATE OR REPLACE FUNCTION f378 (i INTEGER, io IN OUT INTEGER, o OUT INTEGER) RETURN Integer IS
  r INTEGER;
BEGIN
  r := i + io;
  o := io;
...
CREATE OR REPLACE FUNCTION f377 RETURN INTEGER IS
BEGIN
	syntax error;
END f377;
/

CREATE OR REPLACE PROCEDURE p377 RETURN INTEGER IS
BEGIN
	syntax error;
END p377;
/
...
CREATE OR REPLACE PACKAGE library AS
	...
	FUNCTION pkg_f378 (i INTEGER, io IN OUT INTEGER, o OUT INTEGER) RETURN INTEGER;
...
CREATE OR REPLACE PACKAGE BODY library AS
	...
	FUNCTION pkg_f378 (i INTEGER, io IN OUT INTEGER, o OUT INTEGER) RETURN INTEGER IS
	BEGIN
