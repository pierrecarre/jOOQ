...
public class F317 extends StoredFunctionImpl<BigDecimal> {
	...
	private static final long serialVersionUID = -695542337;


	/**
	 * An uncommented item
	 */
	public static final Parameter<BigDecimal> P1 = new ParameterImpl<BigDecimal>("P1", SQLDataType.NUMERIC);

	/**
	 * An uncommented item
	 */
	public static final Parameter<BigDecimal> P2 = new ParameterImpl<BigDecimal>("P2", SQLDataType.NUMERIC);

	/**
	 * An uncommented item
	 */
	public static final Parameter<BigDecimal> P3 = new ParameterImpl<BigDecimal>("P3", SQLDataType.NUMERIC);

	/**
	 * An uncommented item
	 */
	public static final Parameter<BigDecimal> P4 = new ParameterImpl<BigDecimal>("P4", SQLDataType.NUMERIC);

	/**
	 * Create a new function call instance
	 */
	public F317() {
		super(SQLDialect.ORACLE, "F317", Test.TEST, SQLDataType.NUMERIC);
