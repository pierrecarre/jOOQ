...
public final class Library {
	 ...
	 * @param authorName IN parameter
	 * @param result OUT parameter
	 * @param unused OUT parameter
	 */
	public static PkgPAuthorExists2 pkgPAuthorExists2(Connection connection, String authorName) throws SQLException {
	 ...
	 * @param unused
	 */
	public static BigDecimal pkgFAuthorExists2(Connection connection, String authorName, BigDecimal unused) throws SQLException {
	 ...
	 * @param unused
	 */
	public static Field<BigDecimal> pkgFAuthorExists2(String authorName, BigDecimal unused) {
		PkgFAuthorExists2 f = new PkgFAuthorExists2();
		f.setAuthorName(authorName);
		f.setUnused(unused);
