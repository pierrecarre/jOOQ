...
public class PkgFManyParameters extends StoredFunctionImpl<BigDecimal> {

	private static final long serialVersionUID = 982053739;
	...
	public PkgFManyParameters() {
		super(SQLDialect.ORACLE, "PKG_F_MANY_PARAMETERS", Test.TEST, Library.LIBRARY, SQLDataType.NUMERIC);
