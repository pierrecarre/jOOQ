...
public class VLibrary extends TableImpl<VLibraryRecord> {
	...
	private static final long serialVersionUID = 976580926;
	 ...
	 * An uncommented item
	 */
	public static final TableField<VLibraryRecord, String> AUTHOR = new TableFieldImpl<VLibraryRecord, String>(SQLDialect.ORACLE, "AUTHOR", OracleDataType.VARCHAR2, V_LIBRARY);

	/**
	 * An uncommented item
	 */
	public static final TableField<VLibraryRecord, String> TITLE = new TableFieldImpl<VLibraryRecord, String>(SQLDialect.ORACLE, "TITLE", OracleDataType.VARCHAR2, V_LIBRARY);
