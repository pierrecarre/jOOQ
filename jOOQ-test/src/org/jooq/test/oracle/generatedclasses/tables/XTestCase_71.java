...
public class XTestCase_71 extends UpdatableTableImpl<XTestCase_71Record> {
	 ...
	 * An uncommented item
	 * 
	 * FOREIGN KEY [ODS_TEST.X_TEST_CASE_71.TEST_CASE_64_69_ID] REFERENCES X_TEST_CASE_64_69 [ODS_TEST.X_TEST_CASE_64_69.ID]
	 */
	...
	private XTestCase_71() {
		super(SQLDialect.ORACLE, "X_TEST_CASE_71", OdsTest.ODS_TEST);
	}
