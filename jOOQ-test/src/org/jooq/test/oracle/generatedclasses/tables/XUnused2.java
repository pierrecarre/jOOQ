...
import org.jooq.test.oracle.generatedclasses.tables.records.XUnused2Record;
...
public class XUnused2 extends UpdatableTableImpl<XUnused2Record> {
	 ...
	 * PRIMARY KEY
	 */
	public static final TableField<XUnused2Record, Integer> ID = new TableFieldImpl<XUnused2Record, Integer>(SQLDialect.ORACLE, "ID", Integer.class, X_UNUSED_2);
	 ...
	 */
	public static final TableField<XUnused2Record, Integer> UNUSED_ID = new TableFieldImpl<XUnused2Record, Integer>(SQLDialect.ORACLE, "UNUSED_ID", Integer.class, X_UNUSED_2);

	/**
	 * No further instances allowed
	 */
	private XUnused2() {
		super(SQLDialect.ORACLE, "X_UNUSED_2", OdsTest.ODS_TEST);
	}
