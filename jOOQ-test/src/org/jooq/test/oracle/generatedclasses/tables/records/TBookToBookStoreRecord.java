...
public class TBookToBookStoreRecord extends UpdatableRecordImpl<TBookToBookStoreRecord> {
	...
	private static final long serialVersionUID = 1339862579;
	 ...
	 * </pre></code>
	 */
	public void setBookId(BigDecimal value) {
	...
	public TBookRecord getTBook() throws SQLException {
		return create()
			...
			.where(TBook.ID.equal(getValueAsInteger(TBookToBookStore.BOOK_ID)))
			.fetchOne();
	}
