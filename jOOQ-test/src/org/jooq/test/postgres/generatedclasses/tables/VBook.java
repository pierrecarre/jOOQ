...
public class VBook extends TableImpl<VBookRecord> {
	...
	private static final long serialVersionUID = -2003256773;
	 ...
	 * An uncommented item
	 */
	public static final TableField<VBookRecord, UBookStatus> STATUS = new TableFieldImpl<VBookRecord, UBookStatus>("status", PostgresDataType.VARCHAR.asEnumDataType(UBookStatus.class), V_BOOK);
