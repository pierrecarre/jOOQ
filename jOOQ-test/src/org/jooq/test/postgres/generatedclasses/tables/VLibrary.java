...
public class VLibrary extends TableImpl<VLibraryRecord> {
	...
	private static final long serialVersionUID = 1904167127;
	 ...
	 * An uncommented item
	 */
	public static final TableField<VLibraryRecord, String> AUTHOR = new TableFieldImpl<VLibraryRecord, String>(SQLDialect.POSTGRES, "author", PostgresDataType.TEXT, V_LIBRARY);

	/**
	 * An uncommented item
	 */
	public static final TableField<VLibraryRecord, String> TITLE = new TableFieldImpl<VLibraryRecord, String>(SQLDialect.POSTGRES, "title", PostgresDataType.CHARACTERVARYING, V_LIBRARY);
