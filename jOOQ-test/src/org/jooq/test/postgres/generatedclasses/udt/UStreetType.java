...
public class UStreetType extends UDTImpl<UStreetTypeRecord> {
	 ...
	 * An uncommented item
	 */
	public static final UDTField<UStreetTypeRecord, String> NUMBER = new UDTFieldImpl<UStreetTypeRecord, String>(SQLDialect.POSTGRES, "number", String.class, U_STREET_TYPE);
