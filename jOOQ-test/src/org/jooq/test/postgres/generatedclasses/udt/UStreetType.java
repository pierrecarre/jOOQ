...
public class UStreetType extends UDTImpl<UStreetTypeRecord> {
	...
	private static final long serialVersionUID = 1007202914;
	 ...
	 * An uncommented item
	 */
	public static final UDTField<UStreetTypeRecord, Integer[]> FLOORS = new UDTFieldImpl<UStreetTypeRecord, Integer[]>(SQLDialect.POSTGRES, "floors", PostgresDataType.INT4.getArrayDataType(), U_STREET_TYPE);
