...
public class UStreetType extends UDTImpl<UStreetTypeRecord> {
	...
	private static final long serialVersionUID = 1777739575;
	 ...
	 * An uncommented item
	 */
	public static final UDTField<UStreetTypeRecord, String> STREET = new UDTFieldImpl<UStreetTypeRecord, String>(SQLDialect.POSTGRES, "street", String.class, U_STREET_TYPE);

	/**
	 * An uncommented item
	 */
	public static final UDTField<UStreetTypeRecord, String> NO = new UDTFieldImpl<UStreetTypeRecord, String>(SQLDialect.POSTGRES, "no", String.class, U_STREET_TYPE);
