...
public class VLibrary extends TableImpl<VLibraryRecord> {
	...
	private static final long serialVersionUID = 1333545635;
	 ...
	 * An uncommented item
	 */
	public static final TableField<VLibraryRecord, String> AUTHOR = new TableFieldImpl<VLibraryRecord, String>(SQLDialect.SQLITE, "AUTHOR", String.class, V_LIBRARY);

	/**
	 * An uncommented item
	 */
	public static final TableField<VLibraryRecord, String> TITLE = new TableFieldImpl<VLibraryRecord, String>(SQLDialect.SQLITE, "TITLE", String.class, V_LIBRARY);
