...
public class XTestCase_71 extends UpdatableTableImpl<XTestCase_71Record> {
	...
	private static final long serialVersionUID = -1139496535;
	 ...
	 * PRIMARY KEY
	 */
	public static final TableField<XTestCase_71Record, Integer> ID = new TableFieldImpl<XTestCase_71Record, Integer>(SQLDialect.SQLITE, "ID", SQLiteDataType.INT, X_TEST_CASE_71);

	/**
	 * An uncommented item
	 */
	public static final TableField<XTestCase_71Record, Short> TEST_CASE_64_69_ID = new TableFieldImpl<XTestCase_71Record, Short>(SQLDialect.SQLITE, "TEST_CASE_64_69_ID", SQLiteDataType.SMALLINT, X_TEST_CASE_71);
	...
	public UniqueKey<XTestCase_71Record> getMainKey() {
		return Keys.pk_x_test_case_71_ID;
	}

	@Override
	@SuppressWarnings("unchecked")
	public List<UniqueKey<XTestCase_71Record>> getKeys() {
		return Arrays.<UniqueKey<XTestCase_71Record>>asList(Keys.pk_x_test_case_71_ID);
	}
}
