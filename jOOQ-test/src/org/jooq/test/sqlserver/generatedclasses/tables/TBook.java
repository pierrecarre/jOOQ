...
public class TBook extends UpdatableTableImpl<TBookRecord> {
	...
	private static final long serialVersionUID = 1981711985;
	 ...
	 * An uncommented item
	 */
	public static final TableField<TBookRecord, byte[]> CONTENT_PDF = new TableFieldImpl<TBookRecord, byte[]>("content_pdf", SQLDataType.VARBINARY, T_BOOK);
