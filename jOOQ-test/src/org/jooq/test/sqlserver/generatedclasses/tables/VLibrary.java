...
public class VLibrary extends TableImpl<VLibraryRecord> {
	...
	private static final long serialVersionUID = 1419785257;
	 ...
	 * An uncommented item
	 */
	public static final TableField<VLibraryRecord, String> AUTHOR = new TableFieldImpl<VLibraryRecord, String>(SQLDialect.SQLSERVER, "author", SQLServerDataType.VARCHAR, V_LIBRARY);

	/**
	 * An uncommented item
	 */
	public static final TableField<VLibraryRecord, String> TITLE = new TableFieldImpl<VLibraryRecord, String>(SQLDialect.SQLSERVER, "title", SQLServerDataType.VARCHAR, V_LIBRARY);

	/**
	 * No further instances allowed
	 */
	private VLibrary() {
		super(SQLDialect.SQLSERVER, "v_library", Dbo.DBO);
	}
}
