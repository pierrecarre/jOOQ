...
public class XTestCase_71 extends UpdatableTableImpl<XTestCase_71Record> {
	...
	private static final long serialVersionUID = -386776846;
	 ...
	 * PRIMARY KEY
	 */
	public static final TableField<XTestCase_71Record, Integer> ID = new TableFieldImpl<XTestCase_71Record, Integer>(SQLDialect.SQLSERVER, "id", SQLServerDataType.INT, X_TEST_CASE_71);
	 ...
	 * </pre></code>
	 */
	public static final TableField<XTestCase_71Record, Integer> TEST_CASE_64_69_ID = new TableFieldImpl<XTestCase_71Record, Integer>(SQLDialect.SQLSERVER, "test_case_64_69_id", SQLServerDataType.INT, X_TEST_CASE_71);

	/**
	 * No further instances allowed
	 */
	private XTestCase_71() {
		super(SQLDialect.SQLSERVER, "x_test_case_71", Dbo.DBO);
	}
